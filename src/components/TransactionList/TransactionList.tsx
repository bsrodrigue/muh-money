import { View, FlatList, TouchableOpacity, NativeScrollEvent, NativeSyntheticEvent } from 'react-native'
...
export default function TransactionList({ transactions, emptyStr, order = "descending", onPress, onScroll }: TransactionListProps) {
